...
public class Defensor_Troya extends EnemigoDefensor{

	protected String nombre="Eneas de Troya";
	
	public Defensor_Troya(int vida, int ataque, int defensa, int evasion, char estrategia, String estado, String rol, Calculador calc, String nombre) {
