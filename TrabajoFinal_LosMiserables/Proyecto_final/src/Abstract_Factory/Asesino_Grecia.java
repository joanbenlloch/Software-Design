...
public class Asesino_Grecia extends EnemigoAsesino{

	protected String nombre="Ayax de Grecia";
	protected Personaje pj;
	
	public Asesino_Grecia(int vida, int ataque, int defensa, int evasion, char estrategia, String estado, String rol, Calculador calc, String nombre) {
		//super(900, 400, 100, 500, null, "sano", "asesino");
